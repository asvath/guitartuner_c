...
__interrupt void Timer_A (void)
{
  ...
  if ((12288 <current_diff)&&(current_diff<14004)){
    P1OUT=0x01; //E string flat
      P2OUT=0x30;
      display_7seg(0,6);
display_7seg(1,0);
  display_7seg(2,0);
...
display_7seg(1,0);
  ...
  else if ((7812 <current_diff)&&(current_diff<9116)){//A string sharp
      P1OUT=0x01;
      P2OUT=0x18;
      display_7seg(0,5);
display_7seg(1,0);
